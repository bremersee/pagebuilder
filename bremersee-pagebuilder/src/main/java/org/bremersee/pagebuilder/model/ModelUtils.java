...
//     */
//    public static int getTotalPages(long totalSize, PageRequestDto pageRequest) {
//        Validate.notNull(pageRequest, "pageRequest must not be null");
//        if (totalSize <= 0L) {
//            return 1;
//        }
//        return (int) Math.ceil((double) totalSize / (double) pageRequest.getPageSize());
//    }
//
//    
//    
...
//     *             if page is {@code null}
//     */
//    public static Integer getPreviousFirstResult(PageDto page) {
...
//     *             if page is {@code null}
//     */
//    public static Integer getNextFirstResult(PageDto page) {
//        Validate.notNull(page, "page must not be null");
//        // TODO
////        if (page.getTotalSize() != null && page.getFirstResult() != null && page.getMaxResults() != null) {
...
//     *             if page is {@code null}
//     */
//    public static Integer getCurrentPage(PageDto page) {
//        // TODO
////        Validate.notNull(page, "page must not be null");
...
//
     ...
     * {@code fieldSize}). It requires that {@link Page#getTotalPages()} is not
     * {@code null}.
     * 
     * <pre>
     *    ---    ---    ---    ---    ---      ---    ---    ---    ---
     ...
     *             if page is {@code null}
     */
    public static Integer getPaginationSize(PageDto page, int fieldSize) {
        Validate.notNull(page, "page must not be null");
        Integer pageSize = page.getTotalPages();
        if (pageSize != null) {
            if (pageSize == 0) {
                return 0;
            }
